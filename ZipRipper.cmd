...
IF NOT EXIST "%LOGO%" (
IF "%OFFLINE%"=="0" POWERSHELL -nop -c "$progressPreference='silentlyContinue';Invoke-WebRequest -UseBasicParsing -Uri https://raw.githubusercontent.com/illsk1lls/ZipRipper/main/.resources/zipripper.png -o '%LOGO%';$progressPreference='Continue'"
)
