...
IF %ISPERL% EQU 1  CLS&ECHO Extracting required dependencies, this will take a moment...&"%~dp0JtR\7za.exe" x -y "%~dp0perlportable.zip" -o"%~dp0JtR\run">nul&>nul 2>&1 DEL "%~dp0perlportable.zip" /F /Q
